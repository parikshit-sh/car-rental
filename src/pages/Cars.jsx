    ...
    return (
        <div className="px-10 pt-0 lg:pt-10 md:pt-10 pb-44">
          ...
          <Link to="/home"> <span className="text-black text-lg font-semibold pl-10
           hover:text-[#007bff]" >Home</span></Link>/Vehicle Models</motion.h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-0 md:p-4 lg:p-4 lg:pt-32 md:pt-32 pt-10">
        ...
        {carModels.map((car, index) => (
          ...
          viewport={{ once: true, amount: 0.4 }}>
            ...
            <img src={car.image} alt={car.name} className="w-full h-44 object-contain  rounded-md" />
           ...
           <Link to="/home"><button className="mt-4 bg-[#007bff] text-white px-4 
